        ...
        <form action="{{ route('transaksi.update', $transaksi) }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-12 mb-3">
                    ...
                    <select name="akun_id" class="form-select" required>
                        ...
                        <option value="{{ $akun->id }}" {{ $transaksi->akun_id == $akun->id ? 'selected' : '' }}>{{ $akun->nama_akun }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="jumlah" class="form-control" step="0.01" value="{{ $transaksi->jumlah }}" required>
                </div>
            </div>
            <div class="mb-3">
