    ...
    <nav class="sidebar" id="sidebar">
        ...
        <div class="nav flex-column mt-4">
            ...
            <a href="{{ route('pengurus-inti.index') }}" class="nav-link {{ request()->routeIs('pengurus-inti.*') ? 'active' : '' }}">
                <i class="bi bi-person-badge"></i> Dewan Pengurus Harian
            </a>
            ...
            <a href="{{ route('kategori-aset.index') }}" class="nav-link {{ request()->routeIs('kategori-aset.*') ? 'active' : '' }}">
                <i class="bi bi-grid"></i> Kategori Aset
            </a>

            <a href="{{ route('aset.index') }}" class="nav-link {{ request()->routeIs('aset.*') && !request()->routeIs('kategori-aset.*') ? 'active' : '' }}">
