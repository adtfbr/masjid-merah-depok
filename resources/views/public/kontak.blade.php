            ...
            <div class="card card-modern">
                ...
                <div class="card-body p-4">
                    <div class="row align-items-stretch g-4">
                        <!-- KIRI: Transfer Bank -->
                        <div class="col-lg-6">
                            <div class="h-100 p-4 border rounded d-flex flex-column transfer-bank-box"
                                ...
                                <div class="d-flex align-items-center justify-content-center mb-4 flex-grow-1 transfer-bank-content">
                                    <!-- Logo BSN di Kiri -->
                                    <div class="me-4">
